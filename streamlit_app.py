...
# st.info('Веб-приложение для кластеризации ваших данных, хранящихся в эксель-файлах. Перед импортом убедитесь, пожалуйста, что Ваши данные представляют собой структурированную таблицу, а не просто набор данных.
# В противном случае это приведёт к неправильной работе программы.')

st.info('Веб-приложение для кластеризации ваших данных, хранящихся в эксель-файлах. Перед импортом убедитесь, пожалуйста, что Ваши данные представляют собой структурированную таблицу, а не просто набор данных. В противном случае это приведёт к неправильной работе программы.')
st.write("lalala")
...
with st.expander('Кластеризация методом k-means++'):  
  if unploaded_file:
    ...
    st.write('Загрузите файл и проведите предобработку загруженных данных во вкладке "Импорт данных"  ')
